...
//fprintf(hf, "\n\n\n\n\n");
//fprintf(hf, "<img src=\"/home/team63/darknet/data/kiwi.jpg\"/>");
     //  fclose(hf);
//}
	FILE *fp, *fp2;
	    char a;
	 
	   // fp = fopen("/home/team63/darknet/predictions.jpg", "rb");
	    fp = fopen("/home/team63/darknet/data/new_file", "rb");
	    //fp2 = fopen("/var/www/html/output.jpg", "wb");
	    fp2 = fopen("/var/www/html/output.jpg", "wb");
